...
LDYHeightMap::LDYHeightMap(void)
	: m_pMesh(NULL)
	, m_nTile(0)
{
}
...
void LDYHeightMap::Load(string szFolder,
	string szFile,
	string szTexture,
...
bool LDYHeightMap::GetHeight(IN float x, OUT float& y, IN float z)
{
