...
HRESULT LoadingScene::Setup()
{
	...
	m_pMesh = LoadModel("object/xFile/SpaceShip/spaceship.X");
	...
	m_pTextures = TEXTUREMANAGER->GetTexture("object/xFile/SpaceShip/SciFi_Fighter_AK5-diffuse.jpg");
	return S_OK;
}

void LoadingScene::Release()
{
	SKINMANAGER->DeleteMesh("sprites/", "Meteo.X");
	m_pLoading->Release();
...
void LoadingScene::Update()
{
	...
	if (!m_bIsthreading)
	{
		TerminateThread(thread1, dwThread1);
...
void LoadingScene::Render()
{
	...
	GETDEVICE->SetTexture(0, m_pTextures);
...
LPD3DXMESH LoadingScene::LoadModel(const char * filename)
{
	LPD3DXMESH ret = NULL;
