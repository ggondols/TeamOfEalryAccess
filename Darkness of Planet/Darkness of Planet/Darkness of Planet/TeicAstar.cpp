...
vector<D3DXVECTOR3> TeicAstar::FindWay(D3DXVECTOR3 start, D3DXVECTOR3 Last)
{
	int StartX = start.x / NodeLength;
	int StartZ = -( start.z / NodeLength);

	int LastX = Last.x / NodeLength;
	int LastZ = -(Last.z / NodeLength);
	m_Way.clear();
