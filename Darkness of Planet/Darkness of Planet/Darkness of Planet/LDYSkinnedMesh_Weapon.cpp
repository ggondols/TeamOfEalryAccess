...
LDYSkinnedMesh_Weapon::LDYSkinnedMesh_Weapon(char* szFolder, char* szFilename)
	: m_pRootFrame(NULL)
...
{
	LDYSkinnedMesh_Weapon* pSkinnedMesh = SKINMANAGER->GetLDYSkinnedMesh_Weapon(szFolder, szFilename);
...
void LDYSkinnedMesh_Weapon::SetNextAni()
{
...
void LDYSkinnedMesh_Weapon::SetAttackCallbackfunction(CallbackBindFunction function)
{
	m_attackCallback = std::move(function);
}

void LDYSkinnedMesh_Weapon::Load(char* szDirectory, char* szFilename)
{
...
LPD3DXEFFECT LDYSkinnedMesh_Weapon::LoadEffect(char* szFilename)
{
...
void LDYSkinnedMesh_Weapon::SetupBoneMatrixPtrs(ST_BONE* pBone)
{
	assert(pBone);
...
void LDYSkinnedMesh_Weapon::SetAnimationIndex(int nIndex)
{
	if (!m_pAnimController)
		return;
	LPD3DXANIMATIONSET pAnimSet = NULL;
...
void LDYSkinnedMesh_Weapon::Destroy()
{
	cAllocateHierarchy ah;
...
void LDYSkinnedMesh_Weapon::Blending()
{
...
void LDYSkinnedMesh_Weapon::SetRotationAngle(float angle)
{
...
void LDYSkinnedMesh_Weapon::SetAnimation(int num)
{
	m_iNum = num;////////////////
	m_Tracknum = num;
...
void LDYSkinnedMesh_Weapon::ChangeAnimation(int num)
{
	m_Tracknum = num;
	m_Starttime = TIMEMANAGER->getWorldTime();
	m_fWeight = 0;
